...
| `fm-board.sh`            | Drive the Bridge captain dashboard: serve the daemon, ingest, register decisions and live claims, mark answers, refresh, arm answers, and back up |
