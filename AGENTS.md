...
Run `bin/fm-pr-check.sh <id> <PR url>` - it owns the complete merge-wait handoff by recording the PR metadata, arming the merge poll, and marking the task as waiting for the captain's merge.
