...
config/council.json  optional Council roster, seat-to-dispatch-rule mapping, advisory command, and caps; LOCAL, gitignored; see docs/configuration.md "Council"
