...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json council.json crew-harness crew-autocompact backlog-backend backend herdr-project-spaces herdr-presentation-spaces startup-memory-budget trace-context}"
