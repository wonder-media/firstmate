...
# Give older Treehouse doubles an explicit successful legacy help surface.
# Production treats failed or empty help as unreadable; the adversarial case
# that proves that refusal opts out with FM_FAKE_TREEHOUSE_HELP_FAILURE=1.
