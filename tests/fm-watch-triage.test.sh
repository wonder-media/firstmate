...
test_secondmate_status_routine_absorbed_routed_surfaced_classifier() {
  ...
  pass "a secondmate's routine progress absorbs only when provably working and routed lines always surface; its bare turn-end absorbs on any known state; crewmates are unaffected"
}
