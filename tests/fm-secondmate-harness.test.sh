...
test_propagate_lib() {
  ...
  [ -f "$dest/herdr-project-spaces" ] || fail "herdr-project-spaces not propagated"
  ...
  [ -e "$dest/herdr-project-spaces" ] && fail "herdr-project-spaces absence not mirrored downstream"
