...
Deliver lifecycle actions only through `../../../bin/fm-control.sh <task-id> interrupt|exit|relaunch|dormant|wake`; `secondmate-provisioning` owns the dormant/wake policy.
